...
<p> In each of the following pages, you can navigate the corresponding `route/page-name` in the <a href ='https://github.com/rilldata/rill-embedding-example'> GitHub repository </a> for the equivalent iframe request. In some cases, you will need to pass extra parameters to Rill in order 
    ...
    : An embed dashboard that defaults to the Time Dimension Detail page view. Navigation to other types of views allowed.
    <br/><br/>
      <a href="/pivot-view" style=" textDecoration: 'none', color: '#3524c7' ">
      Embed Pivot View
      </a>
      : An embed dashboard that defaults to the Pivot page view. Navigation to other types of views allowed.
      <br/><br/>
      <a href="/error-loading-data" style=" textDecoration: 'none', color: '#3524c7' ">
        Initial Filtered View
      </a>
      : Apply default filters to a dashboard on first load. Users can modify the filters but will reset on refresh. Please refer to our <a href= 'https://docs.rilldata.com/integrate/embedding'> embedding documentation. </a>
      <br/><br/>
